   ...
   <%@ include file="../header.jsp" %>
	...
	<div class="alert alert-danger ${not empty tavoloErrors?'':'d-none' }" role="alert">
		<c:forEach var = "errorItem" items="${tavoloErrors }">
      	...
      	<form  class="form-horizontal" action="/imieitavoli/ExecuteModifica/" method="post">
      	...
      	<input readonly hidden type="text" id="id" name="id" value ="${tavoloAttr.id }">
			...
			<div class="form-group">
		      ...
		      <a href="/imieitavoli/" class="btn btn-primary btn-md">Annulla</a>
		        ...
		        <button type="submit" class="btn btn-primary btn-md">Conferma Modifica Tavolo</button>
		      </div>
		    </div>
		</form>
