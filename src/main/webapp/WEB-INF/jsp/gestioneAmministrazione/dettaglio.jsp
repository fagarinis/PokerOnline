	...
	<div class="container">
		...
		<div class="container-fluid">
			<dl class="row">
				...
				<dd class="col-sm-9">${utenteAttr.id }</dd>
			</dl>
			<dl class="row">
			...
			<dl class="row">
				...
				<dd class="col-sm-9">
				<c:if test="${utenteAttr.ruoli.isEmpty()}"> Nessuno </c:if>
				<c:forEach var="ruoloItem" items="${utenteAttr.ruoli}">
	    	...
	    	<dl class="row">
				<dt class="col-sm-3 text-right">Credito Account</dt>
				<dd class="col-sm-9">${utenteAttr.creditoAcc }</dd>
			</dl>
